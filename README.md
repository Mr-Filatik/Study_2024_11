...
| Номер | Тема | Ссылка на видео | Ссылки | Задания |
| --- | --- | --- | --- | --- |
| 1 | Знакомство, настройка решения, план на курс | [Видео](https://disk.yandex.ru/d/LeAjJyoZv5sAiA) | | Kлонировать себе этот репозиторий и создать свой репозиторий для своего проекта |
