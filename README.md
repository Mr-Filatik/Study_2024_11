...
4. WPF и паттерн MVVM. [Видео](). [Презентация](). Задание: перевести WPF приложение на паттерн MVVM.
5. WPF и внедрение зависимостей. [Видео](). [Презентация](). Задание: добавить в приложении внедрение зависимостей с помощью пакета Microsoft.Extensions.DependencyInjection.
